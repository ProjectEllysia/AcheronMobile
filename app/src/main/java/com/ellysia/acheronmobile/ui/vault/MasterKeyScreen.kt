...
import com.ellysia.acheronmobile.ui.theme.AcheronAuthScaffold
import com.ellysia.acheronmobile.ui.theme.AcheronGold
import com.ellysia.acheronmobile.ui.theme.AcheronLockup
...
import com.ellysia.acheronmobile.ui.theme.WarningCallout
...
private fun LogoutAction(onLogout: () -> Unit) {
    ...
    if (showDialog) {
        LogoutConfirmDialog(
            ...
            onConfirm = { showDialog = false; onLogout() }
        )
    }
    ...
    TextButton(onClick = { showDialog = true }) {
        ...
        Text(
            "¿No eres tú? Cerrar sesión de Ellysia",
