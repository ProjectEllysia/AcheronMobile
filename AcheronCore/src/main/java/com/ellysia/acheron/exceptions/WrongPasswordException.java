package com.ellysia.acheron.exceptions;

/**
 * Thrown when the master password supplied to unlock a vault is incorrect.
 * <p>
 * This exception is raised by {@link com.ellysia.acheron.vault.VaultFactory#fromJSON}
 * in two situations:
 * <ul>
 ...
 *
 * @see com.ellysia.acheron.vault.VaultFactory
