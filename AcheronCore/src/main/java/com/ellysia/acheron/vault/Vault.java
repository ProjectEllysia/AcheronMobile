...
import com.ellysia.acheron.vault.interfaces.Cypher;
import com.ellysia.acheron.vault.secrets.symmetric.VaultEncryptingStrategy;
import com.ellysia.acheron.vault.interfaces.JsonSerializable;
...
public class Vault implements JsonSerializable {
     ...
     * used by {@link com.ellysia.acheron.vault.VaultFactory} to validate that the
